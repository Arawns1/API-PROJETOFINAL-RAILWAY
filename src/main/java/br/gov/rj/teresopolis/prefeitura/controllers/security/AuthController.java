package br.gov.rj.teresopolis.prefeitura.controllers.security;
...
import br.gov.rj.teresopolis.prefeitura.dto.security.JwtResponseDTO;
import br.gov.rj.teresopolis.prefeitura.dto.security.LoginRequestDTO;
import br.gov.rj.teresopolis.prefeitura.dto.security.MessageResponseDTO;
import br.gov.rj.teresopolis.prefeitura.dto.security.SignupRequestDTO;
...
import br.gov.rj.teresopolis.prefeitura.security.jwt.JwtUtils;
...
public class AuthController {
	...
	public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequestDTO loginRequest) {
		...
		return ResponseEntity.ok(
				new JwtResponseDTO(jwt, userDetails.getOrgao(), userDetails.getId(), userDetails.getUsername(), userDetails.getEmail(), roles));
	}
